...
- **`AskUserQuestion`** (via `kata-question`): checklist de minimalismo — pergunte ao usuário, não valide sozinho.
...
Para cada item, use `AskUserQuestion` e pergunte ao usuário (opções fechadas
