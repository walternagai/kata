...
# S7-refactor: I/O de relatório/auditoria vive em report.py. O cli re-exporta
# os nomes para que testes que patcham `kata.cli._print_header` etc.
# continuem a funcionar — o import também garante que as referências abaixo
# (main, _step_report, _step_artifact) resolvam os mesmos objetos.
from kata.report import (  # noqa: E402
    _audit_task,
    _format_auth_line,
    _format_intent_line,
    ...
    _print_doctor,
    _print_header,
    _print_judge_verdict,
)
from kata.skills import DOMAIN_SKILLS, doctor
