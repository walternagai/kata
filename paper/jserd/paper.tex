...
the instructions below mirror that tagged release, and the evaluation
artifacts referenced throughout the paper are listed in the Declarations
section.
...
external-study harness, and the raw results of the evaluations reported in
Section~\ref{sec:impact} are publicly available at
\href{https://github.com/walternagai/kata}{\texttt{github.com/walternagai/kata}}
(commit \texttt{6f56b35}; latest tagged release \texttt{v0.6.0}). The trap
and comparison verdicts used for Tables~\ref{tab:results} and
